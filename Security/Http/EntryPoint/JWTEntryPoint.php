...
class JWTEntryPoint implements AuthenticationEntryPointInterface
{
    ...
    {
        @trigger_error(sprintf('The "%s" class is deprecated since version 2.0 and will be removed in 4.0. Use "%s" instead.', __CLASS__, JWTTokenAuthenticator::class), E_USER_DEPRECATED);
    }
